...
Work stream mapping for parallel task delegation.
...
| 🔩 **Infrastructure** | Set up deployment and environment foundation | Database migrations, CI/CD configuration, Docker/container setup, environment configuration, cloud resources | Migration files, Dockerfiles, pipeline configs, env templates |
