...
skills: unfamiliar-codebase-navigation, tech-stack-detection, codebase-pattern-identification, language-coding-conventions, error-recovery-patterns, documentation-information-extraction, api-contract-design, vulnerability-threat-assessment, code-quality-review-methodology
model: inherit
---
...
Apply the code-quality-review-methodology skill for systematic review dimensions, anti-pattern detection, and feedback patterns. Prioritize by impact: security issues first, then performance, maintainability, and scalability.
