...
skills: codebase-exploration, framework-detection, pattern-recognition, best-practices, documentation-reading, documentation-creation
model: inherit
---
...
Leverage codebase-exploration skill for system discovery and documentation-creation skill for structured output generation.
