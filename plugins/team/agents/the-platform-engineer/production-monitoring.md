...
model: inherit
skills: unfamiliar-codebase-navigation, tech-stack-detection, codebase-pattern-identification, language-coding-conventions, error-recovery-patterns, documentation-information-extraction, production-observability-design
---
...
5. Leverage production-observability-design skill for implementation details
