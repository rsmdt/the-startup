...
model: inherit
skills: codebase-exploration, framework-detection, pattern-recognition, best-practices, error-handling, documentation-reading, cicd-patterns
---
...
5. Leverage cicd-patterns skill for pipeline optimization strategies
