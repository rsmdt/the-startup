...
model: inherit
skills: unfamiliar-codebase-navigation, codebase-pattern-identification, language-coding-conventions, documentation-information-extraction, user-insight-synthesis, user-research-methodology
---
...
Apply the user-research-methodology skill for interview structures, persona templates, journey mapping, and affinity synthesis. Define research questions tied to business objectives.
