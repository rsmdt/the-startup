...
model: inherit
skills: unfamiliar-codebase-navigation, codebase-pattern-identification, language-coding-conventions, documentation-information-extraction, prioritization-framework-application
---
...
Apply the prioritization-framework-application skill for RICE scoring, Value vs Effort matrix, Kano model, MoSCoW categorization, and Cost of Delay analysis. Build phased delivery roadmaps with MVPs.
