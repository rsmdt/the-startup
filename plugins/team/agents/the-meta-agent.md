...
skills: codebase-exploration, framework-detection, pattern-recognition, best-practices, documentation-reading
...
Leverage pattern-recognition and best-practices skills for evidence-based design decisions.
