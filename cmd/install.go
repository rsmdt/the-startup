...
func NewInstallCommand(agents, commands, hooks, templates, settings *embed.FS) *cobra.Command {
	cmd := &cobra.Command{
		Use:   "install",
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return ui.RunMainInstaller(agents, commands, hooks, templates, settings)
		},
	}
